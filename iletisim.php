...
<body>
    ...
    <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
            <h3 class="display-3 font-weight-bold text-white">İletişim</h3>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                ...
                <h1 class="mb-4">Sorularınız İçin Bizimle İletişime Geçin</h1>
            </div>
            <div class="row">
                <div class="col-lg-7 mb-5">
                    <div class="contact-form">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div>
                                <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton">Mesaj Yolla</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-5 mb-5">
                    <p>Aklınıza herhangi bir soru takıldığında ya da yapamadığınız soruları sormak için mail ile bize ulaşabilirsiniz.</p>
                    <div class="d-flex">
